...
This works a little differently than the other tools. First it is meant to work smoothly alongside 
of the matt-pocock skills, so you should install those also (you can use the same link_pi_skills 
function on those also). Second, it has two sections of information, the wiki, and the source material.
EVERYTHING outside of the /wiki folder in your repo is part of the source material, and will be
ingested into the wiki. Third, it is meant to automatically turn all queries about your source material
into wiki lookups, no special skill needed. 
